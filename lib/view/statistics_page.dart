...
class StatisticsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isGoalAchieved = sessionBox.get(
      'todays_words_completed_$today',
      defaultValue: false,
    );

    final totalWords = wordsBox.length;
    final learnedWords = wordsBox.values
        .where((w) => w.correctCount > 0)
        .length;
    final progress = totalWords > 0 ? (learnedWords / totalWords) * 100 : 0.0;

    final reviewWords = wordsBox.values
        .where((w) => w.incorrectCount > 0)
        .length;
    final recommendedLevel = sessionBox.get(
      'recommended_level',
      defaultValue: '기록 없음',
    );
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, box, _) {
        ...
        final String currentTheme = box.get('app_theme', defaultValue: 'auto');
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildStatRow(
                          '오늘의 목표',
                          isGoalAchieved ? '달성 완료 🔥' : '미달성 (오늘의 단어)',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SwitchListTile(
                          ...
                          value: isDarkMode,
                          onChanged: (val) => sessionBox.put('dark_mode', val),
                        ...
                        // 2. 자동 테마 설정 버튼 (강조됨)
                        GestureDetector(
                          onTap: () => sessionBox.put('app_theme', 'auto'),
                          child: Container(
                  ...
                  _buildManagementCard(
                    ...
                    onTap: () => _showResetDialog(
                      context,
                      '모든 학습 기록 초기화',
                      '모든 학습 데이터가 영구적으로 삭제됩니다. 계속하시겠습니까?',
                      () {
  ...
  Widget _buildSeasonalChip(
    ...
    return ChoiceChip(
      ...
      onSelected: (selected) {
        if (selected)
          Hive.box(DatabaseService.sessionBoxName).put('app_theme', value);
      },
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(
                context,
              ).showSnackBar(SnackBar(content: Text('$title 완료되었습니다.')));
            },
            child: const Text(
              '확인',
