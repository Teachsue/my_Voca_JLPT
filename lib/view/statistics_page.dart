              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildManagementCard(
                    ...
                    isDarkMode: isDarkMode,
                    onTap: () => _showResetDialog(context, '모든 학습 기록 초기화', '추천 레벨을 포함한 모든 학습 데이터가 영구적으로 삭제됩니다. 계속하시겠습니까?', () {
                      // 1. 단어장 데이터 초기화
                      ...
                      String currentThemeSetting = sessionBox.get('app_theme', defaultValue: 'auto');
                      bool currentDarkMode = sessionBox.get('dark_mode', defaultValue: false);
                      sessionBox.clear(); 
                      sessionBox.put('app_theme', currentThemeSetting);
                      sessionBox.put('dark_mode', currentDarkMode);
                    }),
                  ),
